...
## ✅ 最新快照（2026-09-22 晚 · 合并待办的第 1~6 步 + A10/B1 补漏做完 · 每步各推一次）
...
第 21 刀 A10 习惯恢复 + B1 补漏（本刀）。
**下一步是「我的」页重构 C6–C12（约 300 行）** —— 那一块按约定要**先出效果图再动代码**，
而且该单独一个 PR，别和 bug 修混。再往后是尾巴（D1–D4 / E1–E3 / F1–F2），多半要真机或外部条件。
